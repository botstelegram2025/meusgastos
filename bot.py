...
async def verificar_senha(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    print(f"[DEBUG] Usuário {chat_id} digitou senha: {senha_digitada}")
    ...
    print(f"[DEBUG] Usuário {chat_id} autenticado, indo para TIPO")
    return TIPO

async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    criar_tabelas()
    chat_id = update.message.chat.id
    print(f"[DEBUG] Start chamado pelo usuário {chat_id}")
...
async def escolher_tipo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    chat_id = update.message.chat.id
    print(f"[DEBUG] Usuário {chat_id} escolheu: {texto}")
